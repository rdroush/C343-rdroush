...
public class CodeBook {
   ...
   * 
   * @param text The text string to create the code book.
   */
   ...
   * 
   * @return The size of the alphabet associated with this book.
   */
  public int size() {
    return book.size();
  }
   ...
   * 
   * @return A textual representation of this code.
   */
   ...
   * @return The bit string encoding for the given character.
   * @throws EncodeException if character is not found in map.
   */
  public String encodeChar(Character ch) {
	String encode = book.get(ch);
	if(encode == null)
