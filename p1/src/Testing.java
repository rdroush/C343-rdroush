...
public class Testing {
  ...
  public void testPutAndGetAt() {
    ...
    // assertEquals(0, ColorTable.getNumCollisions()); //testQuadraticProbingAndResizing() modifies this for some reason?
    table.put(Color.WHITE, 5);
    table.put(Color.RED, 5);
  ...
  // why does this mess with testPutAndGetAt() collision count?
  @Test
