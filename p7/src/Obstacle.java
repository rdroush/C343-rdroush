...
public class Obstacle {
   ...
   * 
   * @param coord The coord to find in the obstacle
   * @return true iff the given coordinate is contained in the region of cells
   * covered by this obstacle.
   */
  public boolean contains(Coord coord) {
    return coord.x >= upperLeft.x 
    	&& coord.x <= lowerRight.x
    	&& coord.y >= upperLeft.y
    	&& coord.y <= lowerRight.y;
  }
